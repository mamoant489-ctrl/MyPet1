...
import com.example.mypet.models.Note;
...
public class NotesAdapter extends RecyclerView.Adapter<NotesAdapter.ViewHolder> {
    ...
    private void updateNote(String noteId, String newText, String reminderTime) {
        DatabaseReference notesRef = FirebaseDatabase.getInstance().getReference()
                .child(FirebasePaths.USERS).child(userId).child("pets").child(petId).child("remaining").child("notes").child(noteId);
    ...
    private void deleteNote(String noteId) {
        FirebaseDatabase.getInstance().getReference()
                .child(FirebasePaths.USERS).child(userId).child("pets").child(petId).child("remaining").child("notes")
